...
//is calculated based on any attributes you see fit. (You do not get extra marks 
//for making the calculation overly complex
...
public class Runner {
	...
	public static void main(String[] args) {
		...
		myGarage.addToList(new Car(3,"Black", 100, 4, true, 4, true, "HONK!"));
		
		myGarage.addToList(new Bicycle(1, "White", 20, 2, false, "RING!", 2));
		
		
		
		ArrayList<Vehicle> myList = myGarage.myList;
		myGarage.calculateCost(myList);
